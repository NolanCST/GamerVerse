...
function RenderHome() {
   return (
      <div className="cardContainer">
         <Stack display="flex" flexDirection="column" spacing={5} useFlexGap flexWrap="wrap">
            <Box display="flex" flexDirection="row" justifyContent="space-around">
               ...
               >
                  ...
                  <ListItem>
                     <ListItemAvatar>
                        <Avatar alt="Kyoichiro" src="/images/avatar/Kyoichiro.jpg"></Avatar>
                     </ListItemAvatar>
                  ...
                  <ListItem>
                     ...
                     <ListItemText sx={{ color: "teal" }} primary="Véronique" secondary="Aslinn - la jinx du groupe (Modératrice)" />
                  </ListItem>
                  <Divider variant="inset" component="li" />
                  <ListItem>
                     <ListItemAvatar>
