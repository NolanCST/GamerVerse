    ...
    >
      ...
      <div className="termCont">
        ...
        <p>
          ...
          http://localhost:5177/Register est la société Nolan State Building,
          dont le siège social est situé au Nolan boulevard Nolan, avec le
          numéro de téléphone :
        ...
        <p>
          ...
          à Internet. Tous les frais supportés par l'Utilisateur pour accéder au
        ...
        <p>
          ...
          droit : · via un formulaire de contact ;
        </p>
        <br />
        ...
        <p>
          ...
          le site http://localhost:5177/Register ne peut être tenu responsable
          ...
          son identifiant et mot de passe. Le site décline toute responsabilité.
          Le site http://localhost:5177/Register ne peut être tenu pour
      ...
      <div className="termCont">
        ...
        <p>
          ...
          http://localhost:5177/Register. Les cookies ne contiennent pas
          ...
          http://localhost:5177/Register. En naviguant sur le site,
        ...
        <br />
        <p>
          Le site permet aux membres de publier les contenus suivants : Post.
          ...
          sans avoir à s’en justifier auprès du membre. Le membre reste
